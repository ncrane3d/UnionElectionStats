        ...
        div(
            layout_column_wrap(
                ...
                card(
                    ...
                    height = height,
                    p("FOR ADVANCED RESEARCHERS ONLY. In merging the fragments of data from many sources,
                      we had to make decisions about how to reconcile differences and prevent duplication.
                      We did our best, but we’re not offended if you want to do it differently.
                      Coming soon, we will have a replication package that transparently shows what we did and
                      encourages jumping in at any point to take a different path.
                      Only use these raw files if you are A) interested in a particular election and
                      want to see the full set of info available on it, even if some of it is wrong, messy, or unintelligible;
                      or B) Very comfortable with data wrangling and well-versed in the NLRB election process/procedures.") %>%
                        tagAppendAttributes(class = "paragraphMarginFix"),
                    #div(
                        #h6("Raw File Types:"),
                ...
                card(
                    ...
                    height = height,
                    p("Below are the variable definitions for the cleaned dataset, as well as a history of version changes.
                      It is automated through the site’s github which can be found here.", tags$a(href="https://github.com/ncrane3d/UnionElectionStats", "here.", target="_blank")) %>%
                        tagAppendAttributes(class = "paragraphMarginFix"),
                    div(
