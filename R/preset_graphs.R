presetGraphModule <- function(id, current_data_slice, customAxesInput, plotTheme, plotMargin, limitToMaxEligible, totalVotes, unionVotes, unionVoteShare, participationRate, statLine) {  
  moduleServer(
    id,
