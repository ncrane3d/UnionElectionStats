  ...
  theme <- bs_theme(
    ...
    bs_add_rules(
      list(
        ...
        "#picketsign {width:30vw;left: 0; right: 0; margin-left: auto; margin-right: auto; position: fixed; top: 5; margin-top: 75px !important;}",
        #Samuel Gompers
        "#gompers {position: fixed; bottom: 0; left: 0; right: 0; margin-left: auto; margin-right: auto;}"
      )
    )
