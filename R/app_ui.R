  ...
  theme <- bs_theme(
    ...
    bs_add_rules(
      list(
        ...
        "#picketsign {width: 25vw; min-width: 500px !important; left: 0; right: 0; margin-left: calc(max(150px, 37vw)); margin-right: auto; position: fixed; max-bottom: 325px; top: 10vh; max-height: 680px !important; font-family: 'Brush Script MT', cursive; padding: 2px !important;}",
        "#picketInput {margin-top: -16px;}",
        #Samuel Gompers
        "#gompers {position: fixed; top: 350px; left: 0; right: 177px; margin-left: auto; margin-right: auto; margin-bottom: 0px; pointer-events: none;display: flex; justify-content: end; float: right;}"
      )
    )
