  ...
  theme <- bs_theme(
    ...
    bs_add_rules(
      list(
        ...
        "#picketsign {width: 25vw; min-width: 200px; left: 0; right: 0; margin-left: calc(max(150px, 37vw)); margin-right: auto; position: fixed; max-bottom: 325px; top: 10vh; max-height: 680px !important; font-family: 'Brush Script MT', cursive; padding: 2px !important;}",
